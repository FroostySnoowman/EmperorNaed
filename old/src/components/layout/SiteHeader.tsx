        ...
        >
          <Link to="/" className="group flex min-w-0 items-center gap-3" aria-label={`${brand.name}, back to home`}>
            ...
            <span className="min-w-0">
              ...
              {brand.role ? (
                <span className="hidden truncate font-mono text-[10px] uppercase tracking-[0.2em] text-white/35 sm:block lg:hidden xl:block">
                  {brand.role}
                </span>
              ) : null}
            </span>
          ...
          <div className="flex shrink-0 items-center gap-3">
            {availability.label ? (
              <span className="hidden items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.03] px-3 py-1.5 2xl:inline-flex">
