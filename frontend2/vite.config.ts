    ...
    transformIndexHtml: {
      ...
      handler(html) {
        ...
        try {
          ...
          console.warn('[social-meta] public/content/site.json unreadable, no meta tags added.')
          return html
        }
        ...
        const description = String(seo.description || brand.summary || '')
        const siteName = String(seo.siteName || brand.name || '')
        const themeColor = String(seo.themeColor || '#e11d2e')
